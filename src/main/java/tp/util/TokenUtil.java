...
public class TokenUtil implements Serializable{
    ...
    public String generateToken(Utilisateur userDetails) {
		...
		return doGenerateToken(claims, userDetails.getEmail()+" "+userDetails.getIdutilisateur());
	}
    ...
    public Boolean validateToken(String token, Utilisateur userDetails) {
		...
		return (username.equals(userDetails.getEmail()+" "+userDetails.getIdutilisateur()) && !isTokenExpired(token));
	}
